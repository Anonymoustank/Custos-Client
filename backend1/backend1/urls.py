...
from todo.views import TokenView, UserView, UserInfoView, TodoView, toggle_admin_status
...
urlpatterns = [
    ...
    path('toggle-admin/<int:user_id>/', toggle_admin_status, name='toggle_admin_status'),  # For Option 1
]